...
echo ""
echo "In System Settings > General > Login Items & Extensions you'll see a"
echo "WhisperDictate entry under 'Allow in Background' (with the green 'exec'"
echo "icon) — that IS the launchd agent. Leave it ON. Only remove an entry"
echo "if you see TWO WhisperDictate rows (one would be a stale manual add)."
echo ""
